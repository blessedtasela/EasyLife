...
public class feedback extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(242, 161, 4));
        jLabel1.setText("FEEDBACK FORM");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/easylife/img/EasyLife-logo.jpg"))); // NOI18N
        ...
        jLabel3.setForeground(new java.awt.Color(29, 101, 166));
        jLabel3.setText("Rate us from 1 to 5, 5 being the highest");

        jComboBox1.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        jComboBox1.setForeground(new java.awt.Color(242, 161, 4));
    ...
    private void taMessageFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_taMessageFocusGained
        ...
        if (taMessage.getText().equals("Tell us about your experience. (Optional)")) {
